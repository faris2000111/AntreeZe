            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                <div class="card card-plain mt-8">
                    ...
                    <div class="card-header pb-0 text-left bg-transparent">
                        <h4 class="mb-0">Lupa Passowrd Anda? Masukkan Email Anda</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="/forgot-password" method="POST" role="form text-left">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn w-100 mt-4 mb-0" style="background-color: {{ $profile->warna }}; color: #FFF;">Pulihkan Password Anda</button>
                            </div>
                        </form>
                    </div>
                </div>
