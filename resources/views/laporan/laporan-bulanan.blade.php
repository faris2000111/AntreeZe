...
<section class="section">
  <div class="row">
        ...
        <div class="card">
            <div class="card-body">   
                <div class="card-header pb-0">
                    <h4 style="text-align:center;">Chart Bulanan</h4>
                </div>
                ...
                <script>
                    ...
                    var myBarChart = new Chart(ctx, {
                        ...
                        data: {
                            labels: @json(array_values($months)), // Label untuk sumbu X (Nama-nama bulan)
                            datasets: @json($chartData) // Dataset yang sudah dikirim dari controller, berisi layanan dan jumlah booking per bulan
                        },
                        options: {
                            responsive: true,
                            scales: {
                                x: {
                                    stacked: false, // Menumpuk bar berdasarkan layanan di setiap bulan
                                    title: {
                                        display: true,
                                        text: 'Bulan dalam Setahun' // Judul untuk sumbu X
                                    }
                                },
                                y: {
                                    beginAtZero: true, // Mulai dari 0 pada sumbu Y
                                    stacked: false, // Menumpuk bar di sumbu Y untuk layanan yang berbeda
                                    title: {
                                        display: true,
    ...
    <div class="col-lg-12 mt-4">
        <div class="card">
            <div class="card-body">          
                <div class="card-header pb-0">
                    <h4 style="text-align:center;">Booking Bulan ini</h4>
                </div> 
  ...
  <div class="col-lg-12 mt-4">
                    <div class="card">
                        <div class="card-body">          
                            <div class="card-header pb-0">
                                <h4 style="text-align:center;">Pengguna Baru Bulan ini</h4>
                            </div> 
                            <div class="table-responsive">
